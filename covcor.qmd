...
Discrete, continuous. @holland_79, @gifi_B_90, @ouimet_21
...
Define a random vector $\ul{e}$, which takes as its values the $p$ unit vectors $e_1,\cdots,e_p$. Unit vector
...
$$
random variable $\ul{x}$ which take value $x_r$ with probability $\pi_r$.
